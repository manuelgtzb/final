...
export const translations = {
  en: {
    ...
    projects: {
      ...
      titles: ["NORTAMA Landing Page", "SOLARE Landing Page", "Archery"], openLabel: "Open project",
    },
    pricing: {
  ...
  es: {
    ...
    projects: {
      ...
      titles: ["Landing Page NORTAMA", "Landing Page SOLARE", "Tiro con arco"], openLabel: "Abrir proyecto",
    },
    pricing: {
